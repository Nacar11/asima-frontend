...
/**
 * Search-driven employee picker for the admin compensation page. Debounced
 * query over /admin/users; clicking a result calls `onSelect`. Mirrors the
 * schedule page's picker — kept slice-local so each owns its cache keys.
 */
export function EmployeePicker({
  ...
  const query = useQuery({
    queryKey: adminCompensationKeys.picker(debounced),
    queryFn: () =>
